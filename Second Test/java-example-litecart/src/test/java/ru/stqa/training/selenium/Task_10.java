...
public class Task_10 {
    ...
    public void myTask_10() {
        ...
        Assert.assertTrue("Акционная цена не жирная!!!",campaign_price_decor1.equals("700"));
        ...
        //driver.findElement(By.xpath("//div[@id='box-campaigns']//div[@class='image-wrapper']")).click();
    }
