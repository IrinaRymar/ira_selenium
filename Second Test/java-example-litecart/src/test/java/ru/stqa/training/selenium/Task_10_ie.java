...
public class Task_10_ie {
    ...
    public void myTask_10_ie() {
        ...
        String regular_price_decor1 = regular_price1.getCssValue("text-decoration");
        ...
        String regular_price_decor2 = regular_price2.getCssValue("text-decoration");
